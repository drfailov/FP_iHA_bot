...
Если возникает ошибка обработки команды, ответ из базы уже не подбирается
команда для удаления ответа из базы по ID (команда "забудь")
Команда для очистки неиспользуемых вложений в базе
Добавлена защита от переполнения по длине вывода команды "ответы"



- воспринимать редактированные сообщения как новые
- при формировании списка ответов если список получается сллишком длинным из-за длинных ответов, останавливать подбор
